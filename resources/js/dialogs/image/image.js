    ...
    UploadImage.prototype = {
        ...
        initUploader: function () {
            ...
            // WebUploader实例
                ...
                actionUrl = editor.options.serverUrl,
            ...
            uploader.on('uploadBeforeSend', function (file, data, header) {
               ...
               //header['X_Requested_With'] = 'XMLHttpRequest';
                ...
                header={'X_Requested_With':'XMLHttpRequest','Access-Control-Allow-Origin':'*'};
    ...
    OnlineImage.prototype = {
        ...
        getImageData: function () {
            ...
            if(!_this.listEnd && !this.isLoadingData) {
                ...
                var url = editor.options.listImage;
                $.ajax({
                    url:url,
                    type:"get",
                    async:false,
        ...
        pushData: function (list) {
            ...
            for (i = 0; i < list.length; i++) {
                if(list[i] && list[i].image_url) {
                    ...
                    img.width = 113;
                    img.setAttribute('src',list[i].image_url);
                    img.setAttribute('_src',list[i].image_url);
